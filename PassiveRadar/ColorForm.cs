...
namespace PasiveRadar
{
    public partial class ColorForm : Form
    {
        ...
        public Color[] ColorTable = new Color[Flags.ColorTableSize];
        ...
        public ColorForm(Color[] LocalColorTable)
        {
            InitializeComponent();
            //Set the color array
            Array.Copy(LocalColorTable, ColorTable, Flags.ColorTableSize);
        ...
        private void button_Ok(object sender, EventArgs e)
        {
            ...
            if (ListOfPoints.Count > 1)
            {
                ...
                ColorPoint ColPoint = new PasiveRadar.ColorForm.ColorPoint();
                ColPoint.PointPosition = Flags.ColorTableSize;
        ...
        private int ConvertPositionToTable(int PositionX)
        {
            ...
            if (pictureBox1.Width > 0)
                Factor = Flags.ColorTableSize / pictureBox1.Width;
            else return 0;
        ...
        {
            ListOfPoints.Clear();
            Array.Clear(ColorTable, 0, Flags.ColorTableSize);
